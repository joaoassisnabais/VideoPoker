...
/**
 * Checks if there is only one card missing in the middle of the hand to get a Straight and if 3 of the cards of the Straight are High cards
 * <p>Adds the cards that the player should keep to a list
 */
public class FourToAnInsideStraightWithThreeHC extends FourToAnInsideStraightWithNoHC {

    /**
     * Constructor of the hand
     * @param hand hand of cards in analysis
     */
    public FourToAnInsideStraightWithThreeHC(Hand hand) {
        super(hand);
        this.setPriority(15);
    }
     ...
     * <p>Checks if the hand has 3 High Cards
     * <p>Adds the four cards that will possibly make the Straight to the list of cards that the player should keep
     * @return True if the hand is a Four to An Inside Straight and has 3 High Cards
     */
    @Override
